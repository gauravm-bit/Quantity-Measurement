...
describe(`Testing for Length measurement`, () => {
...
//1.3 when compared with 0 as input and 0 null as expected should return not equal
it('given null feet when compared should return 0', () => {
    assert.notEqual(Converter.feetToInchConverter(0),null)
})
...
//1.9 when compared with 0 as input and expected as null should return not equal
it('given 0 inch and null when compared should return equal length', () => {
    assert.notEqual(Converter.inchToFeetConverter(0),null)
})
